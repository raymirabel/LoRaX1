...
//#define SCT_30  // 30A current transformer
#define SCT_100   // 100A current transformer
...
#define P_ACT_CAL   1.4718    // Active power calibracion
#define P_REA_CAL   0.9104    // Reactive power calibracion
#define P_APA_CAL   1.1090    // Aparent power calibracion
#define IRMS_OFFSET  -0.03    // Current rms offset calibration (A)
#define CFDEN_VALUE   720     // Pulse output frecuency divisor value (increase value = frequency decreases)


// ADE config...
#define PIN_CS  		  7			  // Define chip select ADE7753
#define PIN_IRQ 		  3       // Define interrupt input for ADE7753 (only hardware interrupt supported)
